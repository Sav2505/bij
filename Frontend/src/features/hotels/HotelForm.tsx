  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth scroll="paper">
      ...
      <DialogContent sx={{ pt: 3, minHeight: 440 }}>
        <Box component="form" id="hotel-form" onSubmit={handleSubmit(onSubmit)} noValidate>

          {/* ── טאב 1: פרטי מלון ── */}
          <Box hidden={activeTab !== 0}>
            <Grid container spacing={2.5}>
              <Grid item xs={12}>
                <Typography variant="subtitle2" color="primary" fontWeight={600} mb={0.5}>מידע כללי</Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                ...
                <Typography variant="subtitle2" color="primary" fontWeight={600} mb={0.5}>פרטים טכניים</Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                <Divider sx={{ mt: 0.5, mb: 1.5 }} />
                <Typography variant="subtitle2" color="primary" fontWeight={600} mb={0.5}>הערות</Typography>
              </Grid>
            ...
            {fields.map((field, index) => (
              <Paper key={field.id} variant="outlined" sx={{ p: 2, mb: 2, borderRadius: 2 }}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={4}>
                    <TextField {...register(`contacts.${index}.email`)} label="אימייל" fullWidth size="small" />
                  </Grid>
                </Grid>
              </Paper>
            ))}
          ...
          <Box hidden={activeTab !== 2}>
            <Grid container spacing={2.5}>
              <Grid item xs={12}>
                <Typography variant="subtitle2" color="primary" fontWeight={600} mb={0.5}>פרטי רישוי</Typography>
              </Grid>
